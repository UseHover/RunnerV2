...
abstract class SDKCallerActivity : AppCompatActivity(), SDKCallerInterface {
    ...
    private fun observeActionViewModel() {
        ...
        actionViewModel.filterParam_toFind_FilteredActions_MediatorLiveData.observe(this) {
        ...
        actionViewModel.networksWithinCountry_toFind_networksOutsideCountry_MediatorLiveData.observe(this) {
            Timber.i("listing : ${it.size}")
        }
    }
