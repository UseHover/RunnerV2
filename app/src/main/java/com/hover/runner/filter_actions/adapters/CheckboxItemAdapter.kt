package com.hover.runner.filter_actions.adapters
...
internal class CheckboxItemAdapter(private val checkBoxItems: List<CheckBoxItem>,
    ...
    private fun AppCompatCheckBox.setTint(tintColor: Int) {
        if (Build.VERSION.SDK_INT < 21) CompoundButtonCompat.setButtonTintList(this, ColorStateList.valueOf(tintColor));
    ...
    inner class CheckBoxViewHolder(itemView: View) :
